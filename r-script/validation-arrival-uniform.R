...
vectorFiles <- scalarFiles <- file.path('validate_static_churn/Donet_Homo_oneRouter_Network-0.vec')
...
hist(series, breaks=100)



plot.ecdf(series, xlab="Inter-arrival times")
