...
, m_average_chunkSent(0.0), m_average_chunkReceived(0.0), m_average_chunkExchanged(0.0)
, m_average_chunkSent_interval(0.0), m_average_chunkReceived_interval(0.0), m_average_chunkExchanged_interval(0.0)
//, m_timeBudget(0.0)
{
