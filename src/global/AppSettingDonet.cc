...
//    m_bufferMapPacketSize_bit = 2 * 8 + (int)(m_bufferMapSize_chunk / 8) * 8 + 1 * 8;
    ...
    constant_packet_size_mesh_partnership_disconnect = 1;
        // 1 byte: Packet type
...
int AppSettingDonet::getPacketSizePartnershipDisconnect(void) const
{
    return constant_packet_size_mesh_partnership_disconnect;
}
