...
public:
   ...
   void collectPeerStatistic(void);
...
private:
   ...
   // ---------------------------- Signals ------------------------------------
   // -- New set of signals
   simsignal_t sig_numActivePeer;
   simsignal_t sig_numPartner;
   simsignal_t sig_globalCI;           // Continuity Index
   simsignal_t sig_globalLoss;
   simsignal_t sig_overlayHopCount;
   simsignal_t sig_s2pDelay;           // Source-to-peer delay
   // ---------------------
