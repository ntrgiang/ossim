...
public:
    ...
    void        addEdge(const int sequence, const IPvXAddress from, const IPvXAddress to);
    ...
    int         removeEdgesRecursive(const IPvXAddress& from, const IPvXAddress& to);

    bool        hasEdge(const std::string& stripe, const IPvXAddress& from, const IPvXAddress& to) const;
    bool        hasEdge(const int sequence, const IPvXAddress& from, const IPvXAddress& to) const;
    bool        empty()                                                                            const;
    ...
    IPvXAddress getPredecessor(const IPvXAddress &ip, const int sequence) const;
